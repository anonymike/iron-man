...
const DEFAULT_ITEMS: CommandItem[] = [
  ...
  },
  {
    id: "page-blog",
    label: "Blog",
    description: "Read field notes from the network",
    keywords: ["blog", "journal", "field notes", "writing"],
    icon: FileText,
    href: "#footer",
    kind: "page",
    badge: "INDEX",
  },
  {
    ...
    label: "Documentation",
    description: "Review technical references and system notes",
    keywords: ["documentation", "docs", "reference", "guides", "api"],
    icon: BookOpen,
    href: "#footer",
    kind: "page",
    badge: "INDEX",
  ...
  },
  {
    ...
    description: "Adaptive models for complex decisions",
    keywords: ["service", "ai", "models", "intelligence", "adaptive"],
    icon: Pulse,
    href: "#systems",
    kind: "service",
  },
  {
    ...
    description: "Connected infrastructure with a human signal",
    keywords: ["service", "internet", "web", "connected", "infrastructure"],
    icon: GlobeHemisphereWest,
    href: "#systems",
    kind: "service",
  },
  {
    ...
    description: "Purpose-built tools for ambitious operators",
    keywords: ["service", "software", "engineering", "tools", "systems"],
    icon: Code,
    href: "#systems",
    kind: "service",
  },
